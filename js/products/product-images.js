...
function getProductMainImage(code) {
    const baseFolder = PATH_RESOLVER.resolve("images/products/smart-home/") + "/";
    ...
    const imageMap = {
        ...
        "C100": PATH_RESOLVER.resolve("images/logos/img1.png"),
...
function getProductImages(code) {
    ...
    const imagesMap = {
        ...
        "C100": [
            PATH_RESOLVER.resolve("images/logos/img1.png")
        ],
        "LS176": [
