            ...
            <div class="container mx-auto px-4">
                <nav class="flex items-center justify-between">
                    ...
                    <div class="hidden lg:flex items-center gap-4">
                        <a href="cart.html" id="cart-counter" class="relative">
            ...
            <div class="container mx-auto px-4 py-20 text-center text-white cta-content" style="position: relative; z-index: 10;">
                <div class="max-w-3xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8">
                        <a href="contact.html" class="bg-white text-purple-600 px-8 py-4 rounded-lg font-bold text-lg hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                            اتصل بنا الآن
                        </a>
                        <a href="contact.html" class="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white hover:text-purple-600 transition-all duration-300">
                            احجز استشارة مجانية
                        </a>
                    </div>
                </div>
