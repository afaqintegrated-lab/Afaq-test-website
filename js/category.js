...
function getCategoryPageName() {
    ...
    if (path.includes('category-hosting.html')) return 'hosting';
    if (path.includes('category-smart-home.html')) return 'smart-home';
    if (path.includes('category-business-systems.html')) return 'business-systems';
    return 'store';
}
