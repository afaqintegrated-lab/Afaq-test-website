...
const CONFIG = {
    ...
    // ==================== LOGOS ====================
    logos: {
        main: "images/afaqLogo.png",
        light: "images/AFAQ-light-logo.png",
    ...
    navigation: {
        main: [
            ...
            { label: "الخدمات", href: "services.html", id: "services" },
            { label: "الحلول", href: "solutions.html", id: "solutions" },
            { label: "المنتجات", href: "products.html", id: "products" },
            { label: "المتجر", href: "store.html", id: "store" },
            { label: "عملاؤنا", href: "clients.html", id: "clients" }
        ],

        sectors: [
            { label: "القطاع الصحي", href: "healthcare.html" },
            { label: "القطاع التعليمي", href: "education.html" },
            { label: "قطاع الأعمال", href: "business.html" },
            { label: "القطاع الحكومي", href: "government.html" },
            { label: "القطاع الصناعي", href: "industrial.html" },
            { label: "القطاع المالي", href: "finance.html" },
            { label: "القطاع الأمني", href: "security.html" },
            { label: "قطاع الاتصالات", href: "telecommunications.html" }
        ],
    ...
    footer: {
        quickLinks: [
            ...
            { label: "عن الشركة", href: "about.html" },
            { label: "الخدمات", href: "services.html" },
            { label: "الحلول", href: "solutions.html" },
            { label: "المنتجات", href: "products.html" },
            { label: "عملاؤنا", href: "clients.html" },
            { label: "اتصل بنا", href: "contact.html" }
        ],

        services: [
            { label: "التصميم والتطوير", href: "services.html#design-development" },
            { label: "البنية التحتية", href: "services.html#infrastructure" },
            { label: "الاستشارات المتخصصة", href: "services.html#consulting" },
            { label: "الأمن السيبراني", href: "services.html#cybersecurity" },
            { label: "الحوسبة السحابية", href: "services.html#cloud" },
            { label: "الشبكات والاتصالات", href: "services.html#networks" }
        ]
    },
    ...
    homePage: {
        ...
        hero: {
            ...
            buttons: [
                { label: "اكتشف خدماتنا", href: "services.html", icon: "fas fa-arrow-left" },
                { label: "احجز استشارة مجانية", href: "contact.html", outline: true }
            ]
        },
        ...
        cta: {
            ...
            buttons: [
                { label: "اتصل بنا الآن", href: "contact.html", primary: true },
                { label: "احجز استشارة مجانية", href: "contact.html", outline: true }
            ]
        }
    },
