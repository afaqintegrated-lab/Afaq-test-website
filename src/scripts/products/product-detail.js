...
function renderBreadcrumb(product) {
    ...
    breadcrumbContainer.innerHTML = `
        ...
        <a href="src/pages/main/store.html" class="hover:text-purple-600 transition-colors">المتجر</a>
        <span class="mx-2">/</span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="p-8 lg:p-12 flex flex-col justify-center">
                    ...
                    <div class="mt-6 flex gap-4">
                        <a href="src/pages/main/contact.html" class="flex items-center gap-2 text-purple-600 hover:text-purple-700 font-semibold">
